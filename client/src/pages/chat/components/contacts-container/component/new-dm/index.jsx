        ...
        <DialogContent className=" bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          {searchedContacts.length <= 0 && (
            <div className=" flex-1 mt-5 md:mt-0 md:flex flex-col justify-center items-center duration-1000 transition-all">
              ...
              />
              <div className=" text-opacity-80 text-white flex flex-col gap-10 items-center lg:text-2xl text-xl mt-5 transition-all duration-300 text-center">
                <h3 className=" poppins-medium">
                  Hi<span className=" text-purple-500">!</span> Search
                  <span className=" text-purple-500"> New Contacts.</span>
                </h3>
              </div>
            </div>
          )}
