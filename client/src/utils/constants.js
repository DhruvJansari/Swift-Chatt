...
export const CREATE_POST_ROUTES = `${POST_ROUTE}/create-post`;
export const GET_ALL_POST_ROUTES = `${POST_ROUTE}/get-all-post`;
export const TOGGLE_LIKE_ROUTES = `${POST_ROUTE}/:postId/like`;
export const TOGGLE_DISLIKE_ROUTES = `${POST_ROUTE}/:postId/dislike`;

// export const DELETE_POST_ROUTES = `${POST_ROUTE}/:postId`
